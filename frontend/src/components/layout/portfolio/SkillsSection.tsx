        ...
        <section className="pf-skills container py-5" id="skills" ref={container}>
            ...
            <div className="pf-skills__matrix mb-5 pb-5">
                <div className="d-flex align-items-center gap-3 mb-4">
                    <span className="pf-horizontal-line flex-grow-0" style={{ width: '48px', height: '1px' }}></span>
                    ...
                    <div className="col-md-6 p-0">
                        <div className="pf-skill-card position-relative p-5 h-100 bg-dark text-white overflow-hidden">
                            ...
                            <div className="position-relative z-1">
                                ...
                                <div className="pf-progress mb-4 bg-secondary bg-opacity-25 rounded-pill overflow-hidden" style={{ height: '6px' }}>
                                    <div className="pf-progress__bar bg-primary h-100" style={{ width: '95%' }}></div>
                                </div>
                                <div className="d-flex flex-wrap gap-2 pf-skill-card__tags">
                                    <span className="badge bg-secondary rounded-2 px-3 py-2 text-uppercase text-dark fw-bold d-flex align-items-center gap-2">
                                        <span className="pf-tag-dot bg-dark rounded-circle" style={{ width: '6px', height: '6px' }}></span> Tailwind CSS
                                    </span>
                                    <span className="badge bg-secondary rounded-2 px-3 py-2 text-uppercase text-dark fw-bold d-flex align-items-center gap-2">
                                        <span className="pf-tag-dot bg-dark rounded-circle" style={{ width: '6px', height: '6px' }}></span> BEM Methodology
                                    </span>
                                    <span className="badge bg-secondary rounded-2 px-3 py-2 text-uppercase text-dark fw-bold d-flex align-items-center gap-2">
                                        <span className="pf-tag-dot bg-dark rounded-circle" style={{ width: '6px', height: '6px' }}></span> Responsive Design
                                    </span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="col-md-6 p-0">
                        <div className="pf-skill-card position-relative p-5 h-100 bg-dark text-white overflow-hidden">
                            ...
                            <div className="position-relative z-1">
                                ...
                                <div className="pf-progress mb-4 bg-secondary bg-opacity-25 rounded-pill overflow-hidden" style={{ height: '6px' }}>
                                    <div className="pf-progress__bar bg-info h-100" style={{ width: '90%' }}></div>
                                </div>
                                <div className="d-flex flex-wrap gap-2 pf-skill-card__tags">
                                    <span className="badge bg-secondary rounded-2 px-3 py-2 text-uppercase text-dark fw-bold d-flex align-items-center gap-2">
                                        <span className="pf-tag-dot bg-primary rounded-circle" style={{ width: '6px', height: '6px' }}></span> TypeScript
                                    </span>
                                    <span className="badge bg-secondary rounded-2 px-3 py-2 text-uppercase text-dark fw-bold d-flex align-items-center gap-2">
                                        <span className="pf-tag-dot bg-primary rounded-circle" style={{ width: '6px', height: '6px' }}></span> React Core
                                    </span>
                                    <span className="badge bg-secondary rounded-2 px-3 py-2 text-uppercase text-dark fw-bold d-flex align-items-center gap-2">
                                        <span className="pf-tag-dot bg-primary rounded-circle" style={{ width: '6px', height: '6px' }}></span> ESNext Features
                                    </span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="col-md-6 p-0">
                        <div className="pf-skill-card position-relative p-5 h-100 bg-dark text-white overflow-hidden">
                            ...
                            <div className="position-relative z-1">
                                ...
                                <div className="pf-progress mb-4 bg-secondary bg-opacity-25 rounded-pill overflow-hidden" style={{ height: '6px' }}>
                                    <div className="pf-progress__bar bg-warning h-100" style={{ width: '75%' }}></div>
                                </div>
                                <div className="d-flex flex-wrap gap-2 pf-skill-card__tags">
                                    <span className="badge bg-secondary rounded-2 px-3 py-2 text-uppercase text-dark fw-bold d-flex align-items-center gap-2">
                                        <span className="pf-tag-dot bg-primary rounded-circle" style={{ width: '6px', height: '6px' }}></span> Server Components
                                    </span>
                                    <span className="badge bg-secondary rounded-2 px-3 py-2 text-uppercase text-dark fw-bold d-flex align-items-center gap-2">
                                        <span className="pf-tag-dot bg-primary rounded-circle" style={{ width: '6px', height: '6px' }}></span> App Router
                                    </span>
                                    <span className="badge bg-secondary rounded-2 px-3 py-2 text-uppercase text-dark fw-bold d-flex align-items-center gap-2">
                                        <span className="pf-tag-dot bg-primary rounded-circle" style={{ width: '6px', height: '6px' }}></span> SEO Optimization
                                    </span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="col-md-6 p-0">
                        <div className="pf-skill-card position-relative p-5 h-100 bg-dark text-white overflow-hidden">
                            ...
                            <div className="position-relative z-1">
                                ...
                                <div className="pf-progress mb-4 bg-secondary bg-opacity-25 rounded-pill overflow-hidden" style={{ height: '6px' }}>
                                    <div className="pf-progress__bar bg-danger h-100" style={{ width: '80%' }}></div>
                                </div>
                                <div className="d-flex flex-wrap gap-2 pf-skill-card__tags">
                                    <span className="badge bg-secondary rounded-2 px-3 py-2 text-uppercase text-dark fw-bold d-flex align-items-center gap-2">
                                        <span className="pf-tag-dot bg-warning rounded-circle" style={{ width: '6px', height: '6px' }}></span> GraphQL/Apollo
                                    </span>
                                    <span className="badge bg-secondary rounded-2 px-3 py-2 text-uppercase text-dark fw-bold d-flex align-items-center gap-2">
                                        <span className="pf-tag-dot bg-warning rounded-circle" style={{ width: '6px', height: '6px' }}></span> RESTful Integration
                                    </span>
                                    <span className="badge bg-secondary rounded-2 px-3 py-2 text-uppercase text-dark fw-bold d-flex align-items-center gap-2">
                                        <span className="pf-tag-dot bg-warning rounded-circle" style={{ width: '6px', height: '6px' }}></span> State Management
                                    </span>
                                </div>
                            </div>
                        </div>
                ...
                <div className="pf-timeline position-relative">
                    ...
                    <div className="row pf-timeline__item align-items-center mb-5">
                        <div className="col-md-6 text-md-end mb-4 mb-md-0 d-md-block d-none">
                            <span className="pf-timeline__time text-uppercase fw-bold text-muted fs-1 opacity-25">Present</span>
                        </div>
                        <div className="col-md-6 position-relative">
                            <div className="pf-timeline__dot position-absolute top-50 start-0 translate-middle rounded-circle border border-4 border-dark bg-primary ms-n5 mt-n2 d-none d-md-block" style={{ width: '20px', height: '20px' }}></div>
                            <div className="pf-glass-card p-4 rounded-4 ms-md-4 border border-secondary border-opacity-25">
                                <span className="text-primary fw-bold text-uppercase d-block mb-2" style={{ fontSize: '12px' }}>Current Milestone</span>
                    ...
                    <div className="row pf-timeline__item align-items-center flex-md-row-reverse mb-5">
                        <div className="col-md-6 text-md-start mb-4 mb-md-0 d-md-block d-none ms-md-auto ms-lg-0 px-md-4">
                            <span className="pf-timeline__time text-uppercase fw-bold text-muted fs-1 opacity-25">2 Years Ago</span>
                        </div>
                        <div className="col-md-6 position-relative">
                            <div className="pf-timeline__dot position-absolute top-50 end-0 translate-middle-y rounded-circle border border-4 border-dark bg-info me-n5 mt-n2 d-none d-md-block" style={{ width: '20px', height: '20px', right: '-10px' }}></div>
                            <div className="pf-glass-card p-4 rounded-4 me-md-5 border border-secondary border-opacity-25 text-md-end">
                                <span className="text-info fw-bold text-uppercase d-block mb-2" style={{ fontSize: '12px' }}>The Specialization Phase</span>
                    ...
                    <div className="row pf-timeline__item align-items-center">
                        <div className="col-md-6 text-md-end mb-4 mb-md-0 d-md-block d-none">
                            <span className="pf-timeline__time text-uppercase fw-bold text-muted fs-1 opacity-25">5 Years Ago</span>
                        </div>
                        <div className="col-md-6 position-relative">
                            <div className="pf-timeline__dot position-absolute top-50 start-0 translate-middle rounded-circle border border-4 border-dark bg-warning ms-n5 border-opacity-50 mt-n2 d-none d-md-block" style={{ width: '20px', height: '20px' }}></div>
                            <div className="pf-glass-card p-4 rounded-4 ms-md-4 border border-secondary border-opacity-25">
                                <span className="text-warning fw-bold text-uppercase d-block mb-2" style={{ fontSize: '12px' }}>Origin Story</span>
                                ...
                                <img src="/images/portfolio/skills-image.jpg" alt="Skills origin" className="w-100 rounded-3 object-fit-cover" style={{ height: '160px', filter: 'grayscale(100%)', opacity: 0.7 }} />
                            </div>
                        </div>
                    </div>
